...
/**
 * Company with MultiPropDataSource and depth=0.
 * 
 * MultiPropDataSource hydrates multiple properties from a single data source call.
 * With depth=0, the nested Employee (leader) inside Team should NOT be hydrated.
 */
#[DataSourcesStore([
    new MultiPropDataSource(id: 'companyData', class: CompanyDataSource::class, method: 'getData'),
])]
class CompanyWithMultiPropDepth0
{
    use LoadableTrait;
    ...
    // This property triggers the MultiPropDataSource and has depth=0
