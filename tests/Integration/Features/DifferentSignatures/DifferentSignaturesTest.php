...
class DifferentSignaturesTest extends TestCase
{
    ...
    public function testPropertiesWithSameClassAndMethodButDifferentArgs(): void
    {
        ...
        $entity = new 
        #[DataSourcesStore([
            new MultiPropDataSource(id: 'data1', class: PersonDataSource::class, method: 'getData', args: ['#id1']),
            new MultiPropDataSource(id: 'data2', class: PersonDataSource::class, method: 'getData', args: ['#id2']),
        ])]
        class(1, 2) {
            use LoadableTrait;
